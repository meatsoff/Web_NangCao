...
-- --------------------------------------------------
-- Date Created: 05/06/2022 18:52:03
-- Generated from EDMX file: C:\Users\chinh\source\HK2_Nam3\Web_NangCao\FinalProject\Douong\DoUongOnline\Models\CoffeeShopModel.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [WebsiteCoffeeShop];
GO
...
GO
IF OBJECT_ID(N'[WebsiteCoffeeShopModelStoreContainer].[FK_CongThuc_NguyenLieu]', 'F') IS NOT NULL
    ALTER TABLE [WebsiteCoffeeShopModelStoreContainer].[CongThuc] DROP CONSTRAINT [FK_CongThuc_NguyenLieu];
GO
IF OBJECT_ID(N'[WebsiteCoffeeShopModelStoreContainer].[FK_CongThuc_SanPham]', 'F') IS NOT NULL
    ALTER TABLE [WebsiteCoffeeShopModelStoreContainer].[CongThuc] DROP CONSTRAINT [FK_CongThuc_SanPham];
GO
...
GO
IF OBJECT_ID(N'[WebsiteCoffeeShopModelStoreContainer].[CongThuc]', 'U') IS NOT NULL
    DROP TABLE [WebsiteCoffeeShopModelStoreContainer].[CongThuc];
GO
